var KK = window.KK = {
	_ucurl:'../passport.chuanke.com/',
	_kkurl:'../www.chuanke.com/',
	_resurl:'../res.ckimg.com/',
	_answerUrl : '../wenda.chuanke.com/',
	_kkdownload:'../download.chuanke.com/client/KK.exe',
	_kkipad:'../kk.chuanke.com/ipad',
	_kkiphone:'../kk.chuanke.com/iphone',
	_kkandroid:'../kk.chuanke.com/android',
	_uploadImgUrl : '../upload.img.chuanke.com/',
	_uploadCourseware : '../web.v.chuanke.com/video.upload',
	//站点名称:index,uc,bbs
	_site:'index',
	_isHome:false,
	//第三方登录
	_sinaLogin:"../passport.chuanke.com/login/auth@from=sina",
	_qqLogin:"../passport.chuanke.com/login/auth@from=qq",
	_rrLogin:"../passport.chuanke.com/login/auth@from=renren",
	_baiduLogin:"../passport.chuanke.com/login/auth@from=baidu",
	...
	init:function() {
		...
		if (this.checkLogin()) {
			...
			if (buy_tip && buy_tip == this.user.userid && ck_buy_mobile_tip && ck_buy_mobile_tip == this.user.userid) {
				...
				$.cookie.set('ck_buy_tips', '0', 0, 'default.htm', 'chuanke.com');
				$.cookie.set('ck_buy_mobile_tips', '0', 0, 'default.htm', 'chuanke.com');
			...
			if (first_login == 1) {
				...
				$.cookie.set('ck_first_login', dateStr, 86400, 'default.htm', 'chuanke.com');
			}
		}
	},
	...
	buildHeaderBar:function() {
		...
		str += '<div class="sn_item hasChild"><a href="javascript:;">客户端下载</a><i class="arrow"></i><ul class="hasChild_sub" style="width:135px;"><li><a href="../kk.chuanke.com/default.htm" target="_blank">传课KK</a></li><li><a href="'+this._kkipad+'" target="_blank">传课KK iPad版</a></li><li><a href="'+this._kkiphone+'" target="_blank">传课KK iPhone版</a></li><li><a href="'+this._kkandroid+'" target="_blank">传课KK Android版</a></li></ul></div>';
		str += '</div>';
		...
		if (this.user.userid > 0) {
			...
			str += '<li><a href="'+this._ucurl+'login/logout/default.htm">退出</a></li>';
			str += '</ul>';
			str += '</div>';
			str += '<span class="c_999 fl">|</span>';
			//消息
