...
{
    var _alpha, _width, _height, _xscale, _yscale, _currentframe, gotoAndStop, _totalframes;
    function Shortcuts()
    {
    } // End of the function
    ...
    static function initShortcuts()
    {
        ...
        var _loc7 = {blur: 1, blurX: 1, blurY: 1, strength: 1, shadowAlpha: 1, highlightAlpha: 1, angle: 1, distance: 1, alpha: 1, color: 1};
        for (var _loc9 in _loc4)
        {
            if (_loc7[_loc4[_loc9].split("_")[1]] === 1)
            {
                methods[_loc4[_loc9] + "To"] = _loc4[_loc9];
            } // end if
        } // end of for...in
        var _loc8 = {__resolve: function (name)
        {
        ...
        {
            com.mosesSupposes.fuse.Shortcuts.shortcuts[_loc9] = _loc8[_loc9];
            if (_loc9 != "alphaTo" && _loc9 != "rotateTo")
            {
        ...
        com.mosesSupposes.fuse.Shortcuts.shortcuts._colorTransform = _loc5._colorTransform;
        com.mosesSupposes.fuse.Shortcuts.shortcuts._fade = _loc5._fade;
        ...
        com.mosesSupposes.fuse.Shortcuts.shortcuts.skipTweenTo = function (seconds, props)
        {
