...
function SoundManager(smURL, smID) {
   ...
   * to set these properties, use the setup() method - eg., soundManager.setup({url: 'swf/default.htm', flashVersion: 9})
   */
  ...
  http = (!overHTTP ? 'http:/'+'default.htm' : ''),
  // mp3, mp4, aac etc.
   ...
   *
   * @param {object} options Option parameters, eg. { flashVersion: 9, url: 'path/to/swfs/default.htm' }
  ...
  featureCheck = function() {
    ...
    if (isSpecial) {
      ...
      if (sm2.useHTML5Audio) {
        ...
        // <d>
        if (isBadSafari) {
          sm2._wD(smc + 'Note_3A Buggy HTML5 Audio in Safari on this OS X release, see https_3A//bugs.webkit.org/show_bug.cgi@id=32159 -' + (!hasFlash ?' would use flash fallback for MP3/MP4, but none detected.' : 'will use flash fallback for MP3/MP4, if available'), 1);
        }
        // </d>
  ...
  createMovie = function(smID, smURL) {
    ...
    if (isIE) {
      ...
      movieHTML = [
        '<object id="' + smID + '" data="' + smURL + '" type="' + oEmbed.type + '" title="' + oEmbed.title +'" classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="' + http+'download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=6,0,40,0/#version=6,0,40,0/default.htm' + http+'download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=6,0,40,0/download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=6,0,40,0">',
        param('movie', smURL),
